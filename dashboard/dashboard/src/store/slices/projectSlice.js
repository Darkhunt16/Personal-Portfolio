...
export const getAllProjects = () => async (dispatch) => {
    ...
    try {
      const {data} = await axios.get(
        "https://personal-portfolio-25a9.onrender.com/api/v1/project/getall",
        { withCredentials: true }
      );
      dispatch(
        projectSlice.actions.getAllProjectsSuccess(data.projects)
      );
  ...
  export const addNewProject = (data) => async (dispatch) => {
    ...
    try {
      const response = await axios.post(
        "https://personal-portfolio-25a9.onrender.com/api/v1/project/add",
        data,
        {
          withCredentials: true,
  ...
  export const deleteProject = (id) => async (dispatch) => {
    ...
    try {
      const {data} = await axios.delete(
        `https://personal-portfolio-25a9.onrender.com/api/v1/project/delete/${id}`,
        {
          withCredentials: true,
        }
      );
  ...
  export const updateProject = (id, newData) => async (dispatch) => {
    ...
    try {
      const {data} = await axios.put(
        `https://personal-portfolio-25a9.onrender.com/api/v1/project/update/${id}`,
        newData,
        {
          withCredentials: true,
          headers: { "Content-Type": "multipart/form-data" },
