...
export const login= (email,password)=>async(dispatch)=>{
    ...
    try {
        const {data}=await axios.post(
            "https://personal-portfolio-25a9.onrender.com/api/v1/user/login",
            {email,password},
...
export const getUser= ()=>async(dispatch)=>{
    ...
    try {
        const {data}=await axios.get(
            "https://personal-portfolio-25a9.onrender.com/api/v1/user/me",
            {withCredentials:true,
            }
        );
...
export const logout= ()=>async(dispatch)=>{
    try {
        const {data}=await axios.get(
            "https://personal-portfolio-25a9.onrender.com/api/v1/user/logout",
            {withCredentials:true,
            }
        );
...
export const updatePassword=(currentPassword, newPassword, confirmNewPassword)=>async(dispatch)=>{
    ...
    try {
        const {data}=await axios.put(
            "https://personal-portfolio-25a9.onrender.com/api/v1/user/update/password",
...
export const updateProfile=(newData)=>async(dispatch)=>{
    ...
    try {
        const {data}=await axios.put(
            "https://personal-portfolio-25a9.onrender.com/api/v1/user/update/me",
            newData,
            {
                withCredentials:true,
