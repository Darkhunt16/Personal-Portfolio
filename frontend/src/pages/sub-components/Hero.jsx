  ...
  return (
    ...
    <div className="w-full">
      ...
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["FULLSTACK DEVELOPER", "COMPETITIVE PROGRAMMER", "AI ENTHUSIAST"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        ...
        <Link to={"https://leetcode.com/u/sandeep020902/"} target="_blank">
  <img
    src="/leetcode.png" // replace with the path to your LinkedIn icon image
    alt="LinkedIn"
    className="text-sky-500 w-7 h-7"
  />
</Link>
<Link to={"https://codeforces.com/profile/sandeep_680"} target="_blank">
  <img
    src="/code-forces.png" // replace with the path to your LinkedIn icon image
    alt="LinkedIn"
    className="text-sky-500 w-7 h-7"
  />
</Link>
<Link to={"https://www.codechef.com/users/sandeep0209"} target="_blank">
  <img
    src="/codechef.png" // replace with the path to your LinkedIn icon image
    alt="LinkedIn"
    className="text-sky-500 w-7 h-7"
  />
</Link>
